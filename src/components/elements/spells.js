...
export const spellList = {
    ...
    "Ember Wisp": {
        "levels": {
            "1": "Summons a small flickering flame that circles you, dealing minor fire damage to nearby enemies."
        },
        "note": "A passive flame that dances around the caster.",
        "name": "Ember Wisp",
        "element": ["fire"],
        "classes": ["Mage"],
        "species": [],
    ...
    "Echo Step": {
        "levels": {
            "1": "After you move, a delayed shadow of you repeats the step 1 second later, confusing enemies."
        },
        "note": "Creates a temporal afterimage of movement.",
        "name": "Echo Step",
        "element": ["shadow"],
        "classes": ["Rogue"],
        "species": [],
        "tier": null,
        "tags": ["illusion", "mobility"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Stone Bloom": {
        "levels": {
            "1": "Causes rocky petals to burst from the ground, shielding an ally for a brief moment."
        },
        "note": "A strange mix of earth and growth, often used defensively.",
        "name": "Stone Bloom",
        "element": ["earth", "plant"],
    ...
    "Moonlight Veil": {
        "levels": {
            "1": "You become faintly transparent at night, increasing evasion slightly."
        },
        "note": "Only activates under the moon or stars.",
        "name": "Moonlight Veil",
        "element": ["light"],
    ...
    "Chill Sap": {
        "levels": {
            "1": "Drains a small amount of vitality from the target and slows their movement."
        },
        "note": "A cold, sap-like curse that seeps into the body.",
        "name": "Chill Sap",
        "element": ["ice", "blood"],
        "classes": ["Witch"],
        "species": [],
    ...
    "Wave Echo": {
        "levels": {
            "1": "Creates a delayed pulse of water that bounces off surfaces, hitting targets behind cover."
        },
        "note": "Used for flushing out hidden enemies.",
        "name": "Wave Echo",
        "element": ["water"],
        "classes": ["Mage", "Hunter"],
        "species": [],
        "tier": "Basic",
        "tags": ["ranged", "ricochet"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Pulse Armor": {
        "levels": {
            "1": "Every 10 seconds, your armor releases a minor electric shock to nearby attackers."
        },
        "note": "A reactive defense spell favored by frontliners.",
        "name": "Pulse Armor",
        "element": ["lightning"],
    ...
    "Ash Binding": {
        "levels": {
            "1": "Covers the ground with ash that slows enemies and leaves behind burning footprints."
        },
        "note": "The ash binds spirits as well as feet.",
        "name": "Ash Binding",
        "element": ["fire", "earth"],
        "classes": ["Warlock", "Mage"],
        "species": [],
        "tier": "Advanced",
        "tags": ["trap", "burn", "snare"],
        "base_spell": "",
        "image": "",
        "negative": true,
        "passive": false,
    ...
    "Wind Whisper": {
        "levels": {
            "1": "Carry your voice on the wind to speak to allies within a wide radius."
        },
        "note": "Used by scouts and wind spirits to coordinate silently.",
        "name": "Wind Whisper",
        "element": ["wind"],
        "classes": ["Scout", "Druid"],
        "species": [],
    ...
    "Omen Sense": {
        "levels": {
            "1": "Feel a subtle pull when danger is nearby. Adds a brief window of awareness before ambushes."
        },
        "note": "An instinctive magical sense, often misinterpreted as 'gut feeling'.",
        "name": "Omen Sense",
        "element": ["none"],
        "classes": ["Any"],
        "species": [],
        "tier": "Passive",
        "tags": ["awareness", "survival"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": true,
    ...
    "Unmake": {
        "levels": {
            "1": "Touch an object to unravel it into mana particles. Does not work on living beings… usually."
        },
        "note": "A forbidden spell once used to disintegrate artifacts.",
        "name": "Unmake",
        "element": ["mana", "void"],
        "classes": ["Mage", "Artificer"],
        "species": [],
        "tier": "Legendary",
        "tags": ["disintegrate", "crafting", "forbidden"],
        "base_spell": "",
        "image": "",
        "negative": true,
        "passive": false,
    ...
    "Spotless Swipe": {
        "levels": {
            "1": "With a swipe of your hand, instantly clean any non-living object. Lemon scent optional."
        },
        "note": "Beloved by tavern staff and royal servants alike.",
        "name": "Spotless Swipe",
        "element": ["air", "water"],
        "classes": ["Servant", "Enchanter"],
        "species": [],
        "tier": "Common",
        "tags": ["utility", "cleaning", "domestic"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Wrist Twist": {
        "levels": {
            "1": "Redirects an incoming melee strike with a sharp flick of the wrist. Requires precise timing."
        },
        "note": "Favored by agile duelists and street fighters.",
        "name": "Wrist Twist",
        "element": ["none"],
        "classes": ["Rogue", "Warrior"],
        "species": [],
        "tier": "Basic",
        "tags": ["parry", "counter", "melee"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Second Thought": {
        "levels": {
            "1": "Allows you to rewind your last spoken sentence and try again. Works once per hour."
        },
        "note": "Invaluable for smooth-talking nobles and chronic overthinkers.",
        "name": "Second Thought",
        "element": ["mind"],
        "classes": ["Bard", "Diplomat"],
        "species": [],
        "tier": "Rare",
        "tags": ["social", "charm", "time"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Worldsnap": {
        "levels": {
            "1": "Shatter the space within 10 meters into unstable shards of reality. Extreme danger to user and foe alike."
        },
        "note": "Only cast by those who’ve abandoned reason.",
        "name": "Worldsnap",
        "element": ["void", "time", "mana"],
        "classes": ["Chronomancer", "Voidborn"],
        "species": [],
        "tier": "Mythic",
        "tags": ["area", "chaos", "reality"],
        "base_spell": "",
        "image": "",
        "negative": true,
        "passive": false,
        ...
        "levels": {
            "1": "Summon a translucent cat paw to gently poke or press buttons from afar."
        },
        "note": "Originally invented by lazy familiars.",
        "name": "Curious Paw",
        "element": ["illusion"],
        "classes": ["Summoner", "Trickster"],
        "species": ["Catfolk", "Fey"],
        "tier": "Minor",
        "tags": ["utility", "funny"],
        "base_spell": "",
    ...
    "Kindle Spark": {
        "levels": {
            "1": "Snap your fingers to ignite a small flame suitable for lighting candles, pipes, or campfires."
        },
        "note": "Taught to children as one of the first practical spells.",
        "name": "Kindle Spark",
        "element": ["fire"],
        "classes": [],
        "species": [],
    ...
    "Boil Bubble": {
        "levels": {
            "1": "Create a hovering bubble of boiling water. Mostly used for tea or cooking on the road."
        },
        "note": "Favored by traveling merchants and old wizards alike.",
        "name": "Boil Bubble",
        "element": ["water"],
        "classes": ["Cook", "Alchemist"],
        "species": [],
        "tier": "Common",
        "tags": ["domestic", "utility"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Shield Tap": {
        "levels": {
            "1": "Tap your shield rhythmically to distract or provoke enemies nearby."
        },
        "note": "Used to break up enemy formations or draw attention during a retreat.",
        "name": "Shield Tap",
        "element": ["none"],
        "classes": ["Warrior", "Paladin"],
        "species": [],
    ...
    "Steady Stance": {
        "levels": {
            "1": "Plant your feet and brace. Gain resistance to knockback and reduce stagger duration."
        },
        "note": "Taught in most martial schools on the first day.",
        "name": "Steady Stance",
        "element": ["earth"],
        "classes": ["Warrior", "Guard", "Monk"],
        "species": [],
        "tier": "Basic",
        "tags": ["defense", "stance"],
        "base_spell": "",
    ...
    "Feather Hands": {
        "levels": {
            "1": "Temporarily lighten your hands, allowing you to carry fragile items or stack heavy loads with ease."
        },
        "note": "Used by shopkeepers, glassblowers, and careful thieves.",
        "name": "Feather Hands",
        "element": ["air"],
        "classes": ["Merchant", "Rogue"],
        "species": [],
        "tier": "Utility",
        "tags": ["lightweight", "precision"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Heavy Lift": {
        "levels": {
            "1": "Temporarily increase lifting capacity by 50% for one minute. No increase in combat damage."
        },
        "note": "A warehouse spell that found its way into adventuring kits.",
        "name": "Heavy Lift",
        "element": ["earth"],
        "classes": ["Laborer", "Knight"],
        "species": [],
        "tier": "Common",
        "tags": ["utility", "strength"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Freshen": {
        "levels": {
            "1": "Removes minor dirt, sweat, or odor from clothes or body. Doesn’t fix damage or stains."
        },
        "note": "A favorite in inns, barracks, and first dates.",
        "name": "Freshen",
        "element": ["air", "water"],
        "classes": ["Commoner", "Servant", "Student"],
        "species": [],
        "tier": "Common",
        "tags": ["cleaning", "hygiene", "flavor"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Basic Parry": {
        "levels": {
            "1": "If timed well, reduces incoming melee damage by half and opens an enemy to counterattack."
        },
        "note": "Not flashy, but incredibly important.",
        "name": "Basic Parry",
        "element": ["none"],
    ...
    "Applause Echo": {
        "levels": {
            "1": "Replays the sound of applause in the room every time someone finishes a sentence. Only stops if someone sneezes."
        },
        "note": "Frequently abused by bards and politicians.",
        "name": "Applause Echo",
        "element": ["sound", "illusion"],
        "classes": ["Bard", "Clown", "Diplomat"],
        "species": [],
        "tier": "Annoying",
        "tags": ["social", "illusion", "chaotic"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    , "Salt Circle": {
        "levels": {
            "1": "Draws a glowing ring of enchanted salt. Prevents spirits, gossip, and certain relatives from entering."
        },
        "note": "Used in séances, teenage breakups, and family dinners.",
        "name": "Salt Circle",
        "element": ["earth", "spirit"],
        "classes": ["Witch", "Grandma"],
        "species": [],
        "tier": "Traditional",
        "tags": ["protection", "ritual", "petty"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Rehearsed Retort": {
        "levels": {
            "1": "For the next hour, when insulted, your brain will automatically generate the perfect comeback—30 seconds later."
        },
        "note": "Not helpful in duels. Excellent in debates.",
        "name": "Rehearsed Retort",
        "element": ["mind"],
        "classes": ["Bard", "Scholar", "Petty Mage"],
        "species": [],
        "tier": "Social",
        "tags": ["humor", "delay", "social"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": true,
    ...
    "Candle Chant": {
        "levels": {
            "1": "Sing near an open flame to synchronize nearby candles into a rhythmic flicker pattern."
        },
        "note": "Traditionally used during moon rites or when vibing alone.",
        "name": "Candle Chant",
        "element": ["fire", "sound"],
        "classes": ["Priest", "Artist", "Cultist"],
        "species": [],
        "tier": "Ritual",
        "tags": ["ritual", "visual", "sound"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Gravity Blink": {
        "levels": {
            "1": "Randomly rotates your local gravity for 1 second. You appear to blink sideways or up walls."
        },
        "note": "Rarely useful. Often hilarious.",
        "name": "Gravity Blink",
        "element": ["gravity", "space"],
        "classes": ["Trickster", "Mage"],
        "species": [],
        "tier": "Weird",
        "tags": ["mobility", "weird"],
        "base_spell": "",
    ...
    "Vibe Field": {
        "levels": {
            "1": "You radiate a subtle aura that synchronizes everyone’s emotional tone. Best used in bars or rituals."
        },
        "note": "Can turn fights into dance parties or vice versa.",
        "name": "Vibe Field",
        "element": ["mind", "spirit"],
        "classes": ["Bard", "Dancer", "Cult Leader"],
        "species": [],
        "tier": "Social Magic",
        "tags": ["emotions", "aura", "chaotic"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Courtly Grace": {
        "levels": {
            "1": "Temporarily enhances posture, poise, and elegance. +1 to Charisma during formal social encounters."
        },
        "note": "Taught at finishing schools for the magically inclined.",
        "name": "Courtly Grace",
        "element": ["none"],
        "classes": ["Diplomat", "Noble", "Bard"],
        "species": [],
        "tier": "Social",
        "tags": ["etiquette", "charm", "buff"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": true,
    ...
    "Whisperthread": {
        "levels": {
            "1": "Magically tether your voice to one other person’s ear within 30 feet. All others hear nothing."
        },
        "note": "Essential for subtle court alliances and backroom deals.",
        "name": "Whisperthread",
        "element": ["sound", "mind"],
        "classes": ["Spy", "Ambassador", "Court Mage"],
        "species": [],
        "tier": "Discreet",
        "tags": ["communication", "stealth", "espionage"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Subtle Spark": {
        "levels": {
            "1": "Light candles or incense in a room without calling attention. Used to shift ambiance during tense moments."
        },
        "note": "Often cast under the table or from inside sleeves.",
        "name": "Subtle Spark",
        "element": ["fire"],
        "classes": ["Servant", "Diplomat", "Priest"],
        "species": [],
        "tier": "Minor Utility",
        "tags": ["flavor", "atmosphere"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Composure Mirror": {
        "levels": {
            "1": "You always look well-rested, composed, and unbothered, regardless of actual stress levels."
        },
        "note": "Beloved by politicians and criminals alike.",
        "name": "Composure Mirror",
        "element": ["illusion", "mind"],
        "classes": ["Noble", "Courtier", "Spy"],
        "species": [],
        "tier": "Social",
        "tags": ["deception", "composure", "illusion"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": true,
    ...
    "Politeness Pact": {
        "levels": {
            "1": "Any attempt to interrupt someone is blocked with a magical tug on the tongue. Duration: 5 minutes."
        },
        "note": "A ceremonial spell invoked during delicate council meetings.",
        "name": "Politeness Pact",
        "element": ["spirit", "law"],
        "classes": ["Cleric", "Diplomat", "Mediator"],
        "species": [],
        "tier": "Civic",
        "tags": ["ritual", "law", "social"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Gracious Exit": {
        "levels": {
            "1": "Automatically produces a perfectly timed excuse to leave a conversation without offending anyone."
        },
        "note": "Comes with a bow, nod, or curtsy, depending on local etiquette.",
        "name": "Gracious Exit",
        "element": ["mind"],
        "classes": ["Noble", "Bard", "Servant"],
        "species": [],
        "tier": "Common",
        "tags": ["social", "escape", "ritual"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Phantom Itch": {
        "levels": {
            "1": "Targets feel a subtle, invisible itch in an unreachable spot. It moves every few seconds."
        },
        "note": "Popular among students. Banned in two magical academies.",
        "name": "Phantom Itch",
        "element": ["illusion", "mind"],
        "classes": ["Trickster", "Student", "Bard"],
        "species": [],
        "tier": "Prank",
        "tags": ["annoyance", "illusion", "mischief"],
        "base_spell": "",
        "image": "",
        "negative": true,
        "passive": false,
    ...
    "Sit Swap": {
        "levels": {
            "1": "Instantly swaps the positions of two seated individuals. Causes extreme confusion and occasional spills."
        },
        "note": "No physical harm… unless soup is involved.",
        "name": "Sit Swap",
        "element": ["space", "chaos"],
        "classes": ["Jester", "Bard", "Illusionist"],
        "species": [],
        "tier": "Trick",
        "tags": ["displacement", "humor"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Quack Curse": {
        "levels": {
            "1": "For the next minute, all of the target’s spoken words are punctuated by random duck quacks."
        },
        "note": "Perfect for ruining serious speeches.",
        "name": "Quack Curse",
        "element": ["sound", "chaos"],
        "classes": ["Prankster", "Witch", "Street Mage"],
        "species": [],
        "tier": "Joke",
        "tags": ["voice", "prank", "chaotic"],
        "base_spell": "",
        "image": "",
        "negative": true,
        "passive": false,
    ...
    "Scent Swap": {
        "levels": {
            "1": "Swaps the body scent of two individuals. Reactions vary wildly depending on hygiene."
        },
        "note": "Can be catastrophic in a crowded ballroom.",
        "name": "Scent Swap",
        "element": ["air", "illusion"],
        "classes": ["Jester", "Bard", "Trickster"],
        "species": [],
        "tier": "Silly",
        "tags": ["smell", "identity", "prank"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Inflate Ego": {
        "levels": {
            "1": "Gives the target a temporary, magically-induced overconfidence. May attempt grand declarations or dancing."
        },
        "note": "Technically a buff. Socially… not always.",
        "name": "Inflate Ego",
        "element": ["mind"],
        "classes": ["Bard", "Enchanter", "Clown"],
        "species": [],
        "tier": "Playful",
        "tags": ["social", "chaotic", "funny"],
        "base_spell": "",
        "image": "",
        "negative": false,
        "passive": false,
    ...
    "Mirror Flip": {
        "levels": {
            "1": "Causes a person’s left and right to feel reversed for five minutes. Harmless, but *very* disorienting."
        },
        "note": "Used during duels to gain an unfair (and hilarious) advantage.",
        "name": "Mirror Flip",
        "element": ["illusion"],
        "classes": ["Duelist", "Trickster", "Apprentice"],
        "species": [],
        "tier": "Harmless",
        "tags": ["coordination", "trick", "fun"],
        "base_spell": "",
        "image": "",
        "negative": true,
        "passive": false,
...
export function getSpell(id, level = 1, upgrade = null) {
    ...
    for (let index = 0; index < spells.length; index++) {
        ...
        if (element) {
            array.push(
                ...
                >
                    {element.name}
                    {element.levels[spells[index].level].description ? (
                        <Span>{element.levels[spells[index].level].description}</Span>
                    ) : (
