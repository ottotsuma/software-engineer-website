...
export const SeaPeople = {
  0: <Content style={{ overflowWrap: "anywhere", width: "100%" }}><h1>Sea people</h1>
    <p>
  ...
  1: <Content style={{ overflowWrap: "anywhere", width: "100%" }}><p>"We'll be there soon." Josh said from behind me.</p>
    <p>
  ...
  2: <Content style={{ overflowWrap: "anywhere", width: "100%" }}><p>
  ...
  3: <Content style={{ overflowWrap: "anywhere", width: "100%" }}><p>
  ...
  4: <Content style={{ overflowWrap: "anywhere", width: "100%" }}><p>
  ...
  5: <Content style={{ overflowWrap: "anywhere", width: "100%" }}><p>
