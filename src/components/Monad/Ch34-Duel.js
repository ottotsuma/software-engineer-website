...
function Placeholder(props) {
  return (
    <Content style={{ overflowWrap: "anywhere", width: "100%" }}>
      ...
      <p>"Just bow, he's some kind of prince after all." Josh hinted. We both bowed at the waist saying nothing in return and the prince looked rather happy with himself.  </p>
      {/* Western Frisian */}
