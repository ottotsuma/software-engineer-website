      ...
      <div className="Frame">
        <div className="Content">
          ...
          <p>
            ...
            Finally Klemens was a level 5 rogue. Since they had not reached
          ...
          <Otto>
            With our combined efforts the Skeleton Soldier soon burst into a
            small pile of items. Each shining with a pale light that indicated
            they were common items. Like the zombies the skeletons dropped
            mostly material items, used for crafting or medicines and the like.
            However unlike the zombies the skeletons materials had a marketable
            value and were less repulsive in nature. Most of it consisted of
            ...
            20% increase that was still only a little more then a 0.5% increase
            for the charm.
          </Otto>
          <Klemens>
            "Man we realllly lucked out. I've been in this dungeon thousands of
            times and I never saw the charm drop before!" Klemens exclaimed.
          </Klemens>
          <Oskar>
          ...
          <Otto>
            It was clear no one in the party would or even could afford to buy
            the bone charm so splitting it between two students and a tag along
            was overwhelmingly generous of the towns rules. Once all the drops
            ...
            a hold of us all and the next moment I was back staring at the hole
            dug into the earth that led into the dungeon.
          </Otto>
          <Anneliese>
            "Come on, we have to go with Oskar to report our success and get
            paid for the loot." Anneliese tugged at my robe bringing me back.
            "Did the skeleton king and queen scare you? They gave me a fight the
            first time too. Do you want to hear the story about them?" Anneliese
            asked.
          </Anneliese>
          <Klemens>
            "It's just a myth, no one really knows what caused the dungeon. My
            pa said all dungeons are different." Klemens added.
          </Klemens>
          <Otto>
            "Mmm even so I'd like to hear it while we wait for Oskar. We won't
            have to do anything during the reporting process right?" I asked
            them back.
          </Otto>
          <Anneliese>
            "That's right. They just say we did well and later we have to write
            about what we could of done better, but I can do that later."
            Anneliese informed me before telling me the tale of the skeletons
            trapped forever in a dungeon.
          </Anneliese>
          <Otto>
            The pair had once been a criminal couple, who had later crowned
            themselves as the king and queen of crime. While there pervious
            crimes had them as wanted individuals their crowning themselves as a
            king and queen was a slap in the face to the ruling class of the
            time. They had set out to put an end to this criminal couple once
            and for all. However the queen was a famously strong lancer and the
            king had served as a soldier before his life of crime and they ended
            up holding out in a cave. Their pursuers had buried them in that
            cave and that cave was now the dungeon and their resting place.
            Since they were a king and queen our expeditions into the dungeon
            were their entertainment. At least that was the myth.
          </Otto>
          <Otto>
            Our reward for finding the charm and spear had been bountiful, at
          ...
          <Otto>
            Out of curiosity I asked them to show me the items I should look out
            for this week. While I would only be running the normal difficulty,
            the pair still wanted to show me the items that dropped from higher
            levels. The highest item was the Bone Lance. With a drop rate lower
            then 0.1%, although no one knew how much lower, it had dropped only
            from the hell mode six times. Well six times it was recorded. The
            dungeons difficulty was set at normal, hard, elite, hell. Needless
            to say although only six had dropped, how many parties could
            actually complete a level 10 hell mode dungeon? If they were a
            higher level their levels would only be synced down when they tried.
            Doing so was akin to suicide for normal people.
          </Otto>
          <Item
            stats={{
