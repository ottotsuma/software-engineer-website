      ...
      <div className="Frame">
        <div className="Content">
          ...
          <p>
            ...
            lower down then the rest of the room, for about half a meter in in
          ...
          <p>
            ...
            black trousers and t-shirt (school and class emblems etc). The next
            uniform was just a 2nd pair of trousers and t-shirt without any
            markings on. The final uniform was much softer and thinner, with a
          ...
          <p>
            ...
            mages: A History". Along side with a note that said "Read Chapter 1
